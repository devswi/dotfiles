...
function M.add_word_to_c_spell_dictionary()
  ...
  local dictionary_path = path.get_root_directory() .. "/.cspell/cspell-tool.txt"

  os.execute("mkdir -p " .. path.get_root_directory() .. "/.cspell")
